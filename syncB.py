...
# Generated: Thu Nov 14 14:19:38 2019
##################################################
...
class sync(gr.top_block, Qt.QWidget):
    ...
    def timing(self):    
        ...
        # Get current hardware time of this radio and block until next pps
         urr_hw_time = self.uhd_usrp_source_0.get_time_last_pps()
        ...
        #     last_pps0 = self.uhd_usrp_source_0.get_time_last_pps()
         ...
         print(time.ctime())
      # current_pps = self.uhd_usrp_source_0.get_time_last_pps() 
      #  self.current_pps = current_pps
